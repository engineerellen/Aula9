...
namespace DAO
{
    public class UsuarioDAO
    {
        ...
        public bool validarLoginSenha(Usuario usu)
        {
            ...
            lstUsuario = lstUsuario.Where(l => l.Login == usu.Login).ToList();
            return lstUsuario.Count > 0;
        ...
        public bool ValidaLogin(Usuario usu)
        {
            List<Usuario> lstUsuario = new List<Usuario>();
            using (SqlConnection con = new SqlConnection(connectionString))
            {
            ...
            lstUsuario = lstUsuario.Where(u => u.Login == usu.Login).ToList();
            return lstUsuario.Count > 0;
